...
Public Class TandaTerimaBarang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Koperasi2.TandaTerimaBarang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTandaTerimaBarang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TandaTerimaBarang = New TandaTerimaBarang
        rpt.Site = Me.Site
        Return rpt
    End Function
