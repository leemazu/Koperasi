...
#Region "connection local"
    ...
    Public Function RunSQL(ByVal SQLCommand As String, ByVal Flag As Integer, Optional ByVal Table As String = "", Optional ByVal ComboTable As DataTable = Nothing)
        ...
        Try
            ...
            If Flag = 0 Then 'Contoh penggunaan untuk query INSERT 
                cmd.ExecuteNonQuery()
            ElseIf Flag = 1 Then 'Contoh Penggunaan Untuk mengambil data per kolom
                With dt
                    .Clear()
                    'dt = New DataTable
            ...
            ElseIf Flag = 2 Then
                ...
                da.Fill(ds, Table)
            ElseIf Flag = 3 Then
                'hanya jika pakai table dengan 2 Kolom (ID dan Value)
                With ComboTable
                    .Rows.Clear()
                    rdr = cmd.ExecuteReader()
                    While rdr.Read()
    ...
    Public Function ExecuteSQL(ByVal SQLCommand As String, ByVal ParamArray params() As SqlParameter) As DataTable
        Dim dt As DataTable = Nothing

        Using da = New SqlDataAdapter(SQLCommand, conn)
            dt = New DataTable
...
#Region "Connection Login"
    Public connServer As String = "MIAOW-PC\SQLEXPRESS"
    'Public connServer As String = "192.168.1.190,1433\SQLEXPRESS"
    Public connDb As String = "Company"
    Public connUser As String = "sa"
    Public connPass As String = "asdf"
    Public cmdLogin As New SqlCommand
    Public rdrLogin As SqlDataReader

    Public connLogin As New SqlConnection("Integrated Security=SSPI;Data Source=" & connServer & ";" & _
    "Initial Catalog=" & connDb & ";Persist Security Info = True;User ID=" & connUser & ";Network Library=DBMSSOCN; Trusted_connection=True;Password=" & connPass)
#End Region
...
#Region "Connection Report"
    ...
    Public repUser = "sa"
    Public repPwd = "asdf"
    Public strRep As String = "Integrated Security=SSPI;Data Source=MIAOW-PC\SQLEXPRESS;" & _
