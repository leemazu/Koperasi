...
Public Class pElektronik
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        With frmTabApp
            .txtFlag.Text = "4"
            .Text = "Tabel Aplikasi Pinjaman Elektronik"
            .Show()
        End With
    End Sub
    ...
    Private Function VcAplikasi() As Boolean
        ...
        If txtKendaraan.Text = "" Then
            alertmsg = "Nama Barang Tidak Boleh Kosong"
            txtKendaraan.Focus()
            hasil = False
        ElseIf txtTipe.Text = "" Then
            alertmsg = "Keterangan Barang Tidak Boleh Kosong"
            txtTipe.Focus()
            hasil = False
        ElseIf txtWarna.Text = "" Then
            alertmsg = "Nomor Seri Tidak Boleh Kosong"
            txtWarna.Focus()
            hasil = False
                ...
                If rdr.HasRows Then
                    ...
                    While rdr.Read()
                        If stateApp = "UPD" Then
                            ...
                            txtDokumen.Text = rdr("ShortageDoc")
    ...
    Private Sub tempTandaTerimaBarang()
        ...
        Try
            RepSQL2 = "INSERT INTO TandaTerimaBarang VALUES ('" & antisqli(txtPemNama.Text) & "','" & antisqli(txtKendaraan.Text) & "'"
            RepSQL2 &= ",'" & antisqli(txtWarna.Text) & "','" & antisqli(txtTipe.Text) & "'"
            RepSQL2 &= ",'" & antisqli(txtAplikasi.Text) & "')"
            connRep2.Open()
        ...
        PrintTandaTerimaBarang()
    End Sub

    Private Sub PrintTandaTerimaBarang()
        dsRep2 = New DataSet
        Try
            RepSQL2 = "SELECT * FROM TandaTerimaBarang where ApplicationID='" & antisqli(txtAplikasi.Text) & "'"

            cmdRep2 = New SqlCommand(RepSQL2, connRep2)
            daRep2 = New SqlDataAdapter(cmdRep2)
            connRep2.Open()
            daRep2.Fill(dsRep2, "TandaTerimaBarang")

        Catch ex As Exception

        End Try
        connRep2.Close()
        RepName2 = "TandaTerimaBarang"
        'RepName2 = "../Rpt/rptTandaTerimaUang.rpt"
